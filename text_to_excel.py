...
# Your text data (copied from your input)
text_data = """
...
def clean_data(df):
    ...
    df = df.applymap(lambda x: re.sub(r'[^\x20-\x7E]', '', str(x)) if isinstance(x, str) else x)
    return df
...
print("Excel file has been created: 'output_data.xlsx'")